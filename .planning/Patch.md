...
## [2026-03-01] 스플래시 스크린 및 시스템 트레이 최소화 기능 추가
- **스플래시 스크린 도입**: 앱 초기화 및 모델 다운로드(임베딩) 시 로딩 상태를 보여주기 위해 커스텀 이미지(`assets/splash image.png`) 기반의 진행률 UI를 추가.
- **백그라운드 초기화 전환**: 메인 윈도우 렌더링 전 무거운 모델 로딩 등으로 인한 프리징 현상을 해소하기 위해 `Indexer` 생성 로직을 `IndexerInitThread`(QThread)로 분리 완료. 
- **커스텀 tqdm 패치 적용**: `huggingface_hub`를 통한 모델 다운로드 진행 상황을 `SplashScreen`의 프로그레스바에 실시간으로 표시하기 위해 런타임 몽키 패치로 내부 `tqdm` 래퍼 훅 구현.
- **시스템 트레이 연동**: 앱 닫기 시 즉시 종료되지 않도록 `close_action` 설정을 도입(`ask`, `minimize`, `exit`). 창 닫기 시 선택 다이얼로그를 통해 '트레이로 최소화' 및 선택 사항 기억 동작을 지원하며, 트레이 아이콘 우클릭으로 프로그램 완전 종료 기능 추가.
 
 # #   [ 2 0 2 6 - 0 3 - 0 1 ]   ? }1F�? ���  ? }1��1u? ������ۊ? ? լ޸  0����  ? �� 
 -   * * 0����  ? ��Ю* * :   ? }1F�? ���  ? }1��1u׬ɿ? ? H u g g i n g F a c e   ? ����? ? ��d$=�  ? |1���o��v�  ������  ? ��m��Z�   ? ���9m���? {1��? ? ? լ޸? �?   ? �,�  ��I���? H���  ? ��=�  ? ��.  
 -   * * ? ��?   p�׬��* * :  
         -   ` u i / w o r k e r s . p y ` ? ? ` I n d e x e r I n i t T h r e a d `   ? ? ���Î�? e$��  �o��E�  �N? ` h u g g i n g f a c e _ h u b . u t i l s . t q d m `   ��d$b�  ����   ? {1��  ? �v�:   ` t q d m ` ? �   ��d$b�? ? ? ��v�  ?  ��? |1 Ř�� �o? ` f r o m   h u g g i n g f a c e _ h u b . u t i l s   i m p o r t   t q d m   a s   O r i g i n a l T q d m `   ? ��m��o? �����  ���� ? �ĸ�o? ? ����? ��&  ? ��.  
         -   G U I   �cI޸  ? ��( N o n - T T Y ) ? ���  ? ��P�  ۊC��? ����? ����  ? |1���o��v�  ` t q d m `   ? ����? ����Z�   ? y�f�  ? c$�? /�L�  ? .�޸? ���  ` d i s a b l e = T r u e `   ? �f�? ? �Z� ��� �[? ? ���  ? ��=�  ۊ��Į.   rn׬0? ? ` i f   g e t a t t r ( s e l f ,   ' d i s a b l e ' ,   F a l s e ) :   r e t u r n `   p�̬��  ۊ���  �o��E�? ? �����? �,�,   �Z��#��o? Q T h r e a d \t? ? �P�  ������\t? ? ���? ? ` t h r e a d _ i n s t a n c e . p r o g r e s s . e m i t ` ) ? ? ? }1F�? ���  ? ��2? ���  ? �ĸ�o? ? e$��  ۊy$��? ? ? ����? ����  ������  ? c$�\t? ? ��=�? ��]��o? ۊ�z�? �ĸ�o? p�׬��.  
 
- 프로그램 최초 실행 시 표시되는 '초기 인덱싱 권장' 대화상자가 스플래시 스크린에 가려지지 않도록 최상단 표시(WindowStaysOnTopHint) 적용

* '파일 - 설정' 메뉴에 '환경 설정' 탭을 추가하고, 여기에 '프로그램 종료 시 시스템 트레이로 최소화' 제어 옵션을 추가했습니다.
* 환경 설정 탭을 위한 전용 스타일시트(settings_dialog.qss)를 추가했습니다.
